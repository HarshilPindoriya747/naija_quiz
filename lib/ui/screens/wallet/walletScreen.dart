                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      alignment: Alignment.center,
                      child: Text(
                        "\N${UiUtils.formatNumber(double.parse(paymentRequest.paymentAmount).toInt())}",
                        style: TextStyle(
                            color: Theme.of(context).backgroundColor,
                            fontSize: 15),
                      ),
          ...
          child: Column(
            children: [
              ...
              Container(
                alignment: Alignment.center,
                child: Text(
                  "${AppLocalization.of(context)!.getTranslatedValues(totalEarningsKey)!} : \N${context.read<TransactionsCubit>().calculateTotalEarnings()}",
                  style: TextStyle(
                    color: Theme.of(context).primaryColor,
                    fontSize: 18.0,
                  ),
